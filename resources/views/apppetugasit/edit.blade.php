...
<form action="{{ route('apppetugasit.update', $data->id) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('put') }}
                ...
                <div class="col-12">
                  <div class="card">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group{{ $errors->has('ket') ? ' has-error' : '' }}">
                            <label for="solusi" class="col-md-4 control-label">Catatan Solusi </label>
                            <div class="col-md-6">
                              <textarea class="form-control" name="solusi" placeholder="Solusi anda"></textarea>
                            </div>
                        </div>
