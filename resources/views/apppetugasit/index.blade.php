...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="card-body">
                  <h4 class="card-title">Data Approve Ticket Petugas IT</h4>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped" id="table">
                      ...
                      @foreach($datas as $data)
                        <tr>
                          <td class="py-1">
                          <a href="{{route('apppetugasit.show', $data->id)}}"> 
                            {{$data->kode_transaksi}}
                          </a>
                          </td>
                          <td>
                          ...
                          <td>
                          <form action="{{ route('apppetugasit.edit', $data->id) }}">
                            <button class="btn btn-info btn-sm" >Approve
                            </button>
                          </form>
