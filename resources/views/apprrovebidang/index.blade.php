...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="card-body">
                  <h4 class="card-title">Data Approve Ticket</h4>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped" id="table">
                      ...
                      @foreach($datas as $data)
                        <tr>
                          <td class="py-1">
                          <a href="{{route('apprrovebidang.show', $data->id)}}"> 
                            {{$data->kode_transaksi}}
                          </a>
                          </td>
                          <td>
                          ...
                          <label class="badge badge-warning">Approve</label>
                            @elseif($data->status_ticket == '3')
                            <label class="badge badge-warning">Sudah Approve Atasan IT</label>
                          ...
                          <td>
                          <form action="{{ route('apprrovebidang.update', $data->id) }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('put') }}
                          ...
                          <form action="{{ route('apprrovebidang.destroy', $data->id) }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('delete') }}
